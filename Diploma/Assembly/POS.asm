...
;-----------------------Start login variable----------------------------------
	...
	choice2             db ?
	validStatus         dw 0
	wrongData           db 0ah,0dh,"Invalid username or password, please enter again$"
...
buyInput proc
    ...
    .buyInputNotPositiveIntegerError:
        ; print new line
        mov ah, 09h
        lea dx, newline
        int 21h
    ...
    .isDigit:
        cmp [gBuy + si], "0"
        jl .buyInputNotPositiveIntegerError

        cmp [gBuy + si], "9"
        jg .buyInputNotPositiveIntegerError
